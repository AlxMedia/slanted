...
class SlantedTabs extends WP_Widget {

/*  Constructor
/* ------------------------------------ */
	function __construct() {
		parent::__construct( false, esc_html__( 'Alx Tabs', 'slanted' ), array('description' => esc_html__('List posts, comments, and/or tags with or without tabs.', 'slanted' ), 'classname' => 'widget_slanted_tabs', 'customize_selective_refresh' => true ) );
	}

	public function slanted_get_defaults() {
		return array(
			'title'				=> '',
			'tabs_category'		=> 1,
			'tabs_date'			=> 1,
...
/* ------------------------------------ */
	private function _create_tabs($tabs,$count) {
		...
		$titles = array(
			'recent'	=> esc_html__('Recent Posts','slanted'),
			'popular'	=> esc_html__('Popular Posts','slanted'),
			'comments'	=> esc_html__('Recent Comments','slanted'),
			'tags'		=> esc_html__('Tags','slanted')
		);
		$icons = array(
...
/* ------------------------------------ */
	public function widget($args, $instance) {
		...
		$defaults = $this -> slanted_get_defaults();
			...
			<ul id="tab-comments-<?php echo $this -> number ?>" class="alx-tab group <?php if($instance['comments_avatars']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
						...
						<div class="tab-item-inner group">
							...
							<div class="tab-item-name"><?php echo esc_attr( $comment->comment_author ); ?> <?php esc_html_e('says:','slanted'); ?></div>
...
?>
	...
	<div class="alx-options-tabs">
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php esc_html_e( 'Title:', 'slanted' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr($instance["title"]); ?>" />
		</p>

		<h4><?php esc_html_e( 'Recent Posts', 'slanted' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_enable') ); ?>"><?php esc_html_e( 'Enable recent posts', 'slanted' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'slanted' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_num") ); ?>"><?php esc_html_e( 'Items to show', 'slanted' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'slanted' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("recent_cat_id"), 'selected' => $instance["recent_cat_id"], 'show_option_all' => esc_html__('All','slanted'), 'show_count' => true ) ); ?>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Most Popular', 'slanted' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_enable') ); ?>"><?php esc_html_e( 'Enable most popular posts', 'slanted' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'slanted' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_num") ); ?>"><?php esc_html_e( 'Items to show', 'slanted' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'slanted' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("popular_cat_id"), 'selected' => $instance["popular_cat_id"], 'show_option_all' => esc_html__('All','slanted'), 'show_count' => true ) ); ?>
		</p>
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>"><?php esc_html_e( 'Post with most comments from:', 'slanted' ); ?></label>
			<select style="width: 100%;" id="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>" name="<?php echo esc_attr( $this->get_field_name("popular_time") ); ?>">
			  <option value="0"<?php selected( $instance["popular_time"], "0" ); ?>><?php esc_html_e( 'All time', 'slanted' ); ?></option>
			  <option value="1 year ago"<?php selected( $instance["popular_time"], "1 year ago" ); ?>><?php esc_html_e( 'This year', 'slanted' ); ?></option>
			  <option value="1 month ago"<?php selected( $instance["popular_time"], "1 month ago" ); ?>><?php esc_html_e( 'This month', 'slanted' ); ?></option>
			  <option value="1 week ago"<?php selected( $instance["popular_time"], "1 week ago" ); ?>><?php esc_html_e( 'This week', 'slanted' ); ?></option>
			  <option value="1 day ago"<?php selected( $instance["popular_time"], "1 day ago" ); ?>><?php esc_html_e( 'Past 24 hours', 'slanted' ); ?></option>
			</select>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Recent Comments', 'slanted' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_enable') ); ?>"><?php esc_html_e( 'Enable recent comments', 'slanted' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_avatars') ); ?>"><?php esc_html_e( 'Show avatars', 'slanted' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("comments_num") ); ?>"><?php esc_html_e( 'Items to show', 'slanted' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tags', 'slanted' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tags_enable') ); ?>"><?php esc_html_e( 'Enable tags', 'slanted' ); ?></label>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Tab Order', 'slanted' ); ?></h4>

		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_recent") ); ?>"><?php esc_html_e( 'Recent posts', 'slanted' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_popular") ); ?>"><?php esc_html_e( 'Most popular', 'slanted' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_comments") ); ?>"><?php esc_html_e( 'Recent comments', 'slanted' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_tags") ); ?>"><?php esc_html_e( 'Tags', 'slanted' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tab Info', 'slanted' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_category') ); ?>"><?php esc_html_e( 'Show categories', 'slanted' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_date') ); ?>"><?php esc_html_e( 'Show dates', 'slanted' ); ?></label>
		</p>
...
/*  Register widget
/* ------------------------------------ */
if ( ! function_exists( 'slanted_register_widget_tabs' ) ) {

	function slanted_register_widget_tabs() {
		register_widget( 'SlantedTabs' );
	}

}
add_action( 'widgets_init', 'slanted_register_widget_tabs' );
