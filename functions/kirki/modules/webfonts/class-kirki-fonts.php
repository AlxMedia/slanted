...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'blogline' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'blogline' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'blogline' ),
			'200'       => esc_attr__( 'Light 200', 'blogline' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'blogline' ),
			'300'       => esc_attr__( 'Book 300', 'blogline' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'blogline' ),
			'400'       => esc_attr__( 'Normal 400', 'blogline' ),
			'regular'   => esc_attr__( 'Normal 400', 'blogline' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'blogline' ),
			'500'       => esc_attr__( 'Medium 500', 'blogline' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'blogline' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'blogline' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'blogline' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'blogline' ),
			'700'       => esc_attr__( 'Bold 700', 'blogline' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'blogline' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'blogline' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'blogline' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'blogline' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'blogline' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'blogline' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'blogline' ),
		);
	}
