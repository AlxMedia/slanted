...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'slanted' ),
				'remove'         => esc_attr__( 'Remove', 'slanted' ),
				'default'        => esc_attr__( 'Default', 'slanted' ),
				'selectFile'     => esc_attr__( 'Select File', 'slanted' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'slanted' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'slanted' ),
			)
		);
