...
if ( ! function_exists( 'slanted_styles' ) ) {
	...
	function slanted_styles() {
		...
		if ( get_theme_mod('custom','off') == 'on' ) { wp_enqueue_style( 'slanted-custom', get_template_directory_uri().'/custom.css' ); }
		wp_enqueue_style( 'slanted-font-awesome', get_template_directory_uri().'/fonts/font-awesome.min.css' );
	}
...
/*  Page title
/* ------------------------------------ */
if ( ! function_exists( 'slanted_page_title' ) ) {

	function slanted_page_title() {
		global $post;
...
/*  Custom rss feed
/* ------------------------------------ */
if ( ! function_exists( 'slanted_feed_link' ) ) {

	function slanted_feed_link( $output, $feed ) {
...
add_filter( 'feed_link', 'slanted_feed_link', 10, 2 );
